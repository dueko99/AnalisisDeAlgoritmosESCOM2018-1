...
/*
		...
		./LinealSearch n t v <10millones.txt >> Lineal.txt
		donde n es el tamaño de la busqueda
		t es el numero de threds
		v es el valor a busar
*/
...
int main(int argc,char **argv){
  ...
  int threads=atoi(argv[2]);
	...
	pthread_t *thread;//arreglo para la identificacion de los threads
	thread = (pthread_t*)malloc(threads*sizeof(pthread_t));//Crea el arreglo de threds
	if(SequentalSearch(Data,value,size)){
